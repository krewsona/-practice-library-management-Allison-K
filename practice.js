...
class Book extends LibraryItem {
    ...
    getDetails() { //added this AFTER seeing soltution
        return `${this.title}: written by ${this.author}. Genre: ${this.genre}. ISBN: ${this.isbn}.`
     }
}
...
class Dvd extends LibraryItem {
    ...
    getDetails() { //added this after seeing soltution
        return `${this.title}: Directed by: ${this.director}. Genre: ${this.genre}. Duration: ${this.duration}. UPC: ${this.upc}.`;
    }
}
...
class Magazine extends LibraryItem {
    ...
    getDetails() { //added this after seeing soltution
        return `${this.title}: Published by: ${this.publisher}. Issue: ${this.issueNummber}.`;
    }
}
...
//I added this after seeing soltution
console.log(americanPsycho.getDetails());
console.log(aCourtOfThornsAndRoses.getDetails());
console.log(sportsIllustrated.getDetails());
